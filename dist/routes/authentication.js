...
const verficationCode_1 = __importDefault(require("@controllers/verficationCode"));
const router = (0, express_1.Router)();
router.post("/login", login_1.default);
router.post("/signup", signup_1.default);
router.post("/generateCode", verficationCode_1.default.generateCode);
router.post("/verifyCode", verficationCode_1.default.verifyCode);
